...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--display_server', type=str, default="http://c73ffabb05a3", help='visdom server of the web display')
        # self.parser.add_argument('--display_server', type=str, default="161.122.63.221", help='visdom server of the web display')
